//
//  FavsPlacesViewController.swift
//  FBSearch
//
...
class FavsPlacesViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "EventsFavsDetail", sender: nil)
